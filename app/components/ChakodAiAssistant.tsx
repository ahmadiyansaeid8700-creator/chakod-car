  ...
  return {
    ...
    content:
      mode === "admin"
        ...
        : "سلام، من هوش چاکود هستم. می‌توانم بین آگهی‌ها بگردم، خودروها را مقایسه کنم، درباره قیمت راهنمایی بدهم و برای ثبت آگهی بهتر کمکت کنم.",
  };
}
  ...
  const modeCopy = useMemo(
    () =>
      mode === "admin"
        ...
        : {
            title: "هوش چاکود",
            subtitle: "دستیار خرید، مقایسه و آگهی خودرو",
            placeholder: "مثلاً: تا ۲ میلیارد چی بخرم؟",
          },
    [mode],
  );
