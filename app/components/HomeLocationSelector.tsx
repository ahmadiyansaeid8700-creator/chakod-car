  ...
  return (
    <div className="chakodLocationSelector" dir="rtl">
      ...
      <style>{`
        ...
        .chakodLocationSelected{min-width:0;overflow:hidden;padding:12px 20px;border-bottom:1px solid #f1ecf4;background:#fcfaff}.chakodLocationSelectedHead{display:flex;justify-content:space-between}.chakodLocationSelectedHead strong,.chakodLocationSelectedHead button{font-size:12px}.chakodLocationSelectedHead button{border:0;color:#7c3aed;background:transparent;cursor:pointer;font-weight:800}.chakodLocationChips{width:100%;max-width:100%;min-width:0;margin-top:10px;display:flex;gap:8px;overflow-x:auto;overflow-y:hidden;overscroll-behavior-inline:contain;scrollbar-width:thin}.chakodLocationChips>button{min-height:34px;padding:0 10px;border:1px solid #ded2eb;border-radius:11px;display:flex;align-items:center;gap:6px;white-space:nowrap;color:#5b21b6;background:#fff;cursor:pointer;font-size:12px;font-weight:800}.chakodLocationChips small{color:#9a8da3;font-size:10px;font-weight:400}.chakodLocationChips span{font-size:14px}
