...
export const PRELAUNCH_BUSINESSES = ([
  [9500001, "car_service", "TEST_ دیتیلینگ سبز", "تهران", "تهران", "شهرک غرب", "سرامیک بدنه، صفرشویی و دیتیلینگ حرفه‌ای", ["دیتیلینگ", "سرامیک بدنه", "صفرشویی"], ["detailing", "ceramic_coating"]],
  [9500002, "car_service", "TEST_ کارواش همراه سپید", "فارس", "شیراز", "معالی‌آباد", "کارواش، نظافت داخل کابین و خدمات سیار خودرو", ["کارواش", "خدمات سیار", "نظافت کابین"], ["car_wash"]],
  [9500003, "parts_store", "TEST_ یدک آریا", "البرز", "کرج", "گوهردشت", "قطعات مصرفی، فیلترها و لوازم جانبی خودرو", ["قطعات یدکی", "فیلتر", "لوازم جانبی"], ["spare_parts"]],
  [9500004, "parts_store", "TEST_ باتری و لاستیک شرق", "خراسان رضوی", "مشهد", "سجاد", "باتری، لاستیک، رینگ و لوازم مصرفی", ["باتری", "لاستیک", "رینگ"], ["spare_parts"]],
  [9500005, "repair_shop", "TEST_ تعمیرگاه دنا", "اصفهان", "اصفهان", "خانه اصفهان", "مکانیکی، سرویس دوره‌ای و تعویض روغن", ["مکانیکی", "سرویس دوره‌ای", "تعویض روغن"], ["mechanical", "oil_change"]],
  [9500006, "repair_shop", "TEST_ برق خودرو شمال", "مازندران", "ساری", "فرهنگ", "برق خودرو، دیاگ و تعمیر ECU", ["برق خودرو", "دیاگ", "ECU"], ["auto_electrical"]],
  [9500007, "car_service", "TEST_ محافظ رنگ پایتخت", "تهران", "تهران", "پاسداران", "نصب محافظ رنگ PPF و پوشش‌های محافظ بدنه", ["محافظ رنگ PPF", "پولیش", "محافظ بدنه"], ["ppf"]],
  [9500008, "car_service", "TEST_ شیشه دودی آفتاب", "آذربایجان شرقی", "تبریز", "ولیعصر", "شیشه دودی استاندارد، UV و خدمات نصب", ["شیشه دودی", "UV", "نصب تخصصی"], ["window_tint"]],
  [9500009, "car_service", "TEST_ کاور بدنه پارس", "فارس", "شیراز", "قصردشت", "کاور رنگی بدنه و تغییر ظاهر خودرو", ["کاور بدنه", "کاور رنگی", "طراحی ظاهری"], ["vehicle_wrap"]],
  [9500010, "car_service", "TEST_ صوت و امنیت کارن", "خوزستان", "اهواز", "کیانپارس", "سیستم صوتی، مانیتور، دزدگیر و ردیاب", ["سیستم صوتی", "دزدگیر", "ردیاب"], ["audio_alarm"]],
  [9500011, "car_service", "TEST_ کارواش بخار کاسپین", "گیلان", "رشت", "گلسار", "کارواش بخار، موتورشویی و صفرشویی", ["کارواش", "بخارشویی", "صفرشویی"], ["car_wash"]],
  [9500012, "car_service", "TEST_ دیتیلینگ آبی", "هرمزگان", "بندرعباس", "گلشهر", "دیتیلینگ کامل، احیای رنگ و سرامیک بدنه", ["دیتیلینگ", "احیای رنگ", "سرامیک بدنه"], ["detailing", "ceramic_coating"]],
  [9500013, "parts_store", "TEST_ قطعه بازار مرکزی", "تهران", "تهران", "چراغ برق", "قطعات موتوری، جلوبندی و مصرفی خودرو", ["قطعات موتوری", "جلوبندی", "قطعات مصرفی"], ["spare_parts"]],
  [9500014, "parts_store", "TEST_ یدک البرز", "قزوین", "قزوین", "مینودر", "لوازم یدکی خودروهای داخلی و وارداتی", ["لوازم یدکی", "قطعات وارداتی", "قطعات داخلی"], ["spare_parts"]],
  [9500015, "parts_store", "TEST_ رینگ و تایر ساحل", "گیلان", "بندر انزلی", "غازیان", "فروش تایر، رینگ و تجهیزات چرخ", ["لاستیک", "رینگ", "بالانس"], ["spare_parts"]],
  [9500016, "repair_shop", "TEST_ مکانیکی پایتخت", "تهران", "تهران", "تهرانپارس", "تعمیر موتور، گیربکس و سرویس دوره‌ای", ["مکانیکی", "موتور", "گیربکس"], ["mechanical"]],
  [9500017, "repair_shop", "TEST_ سرویس روغن سپهر", "قم", "قم", "سالاریه", "تعویض روغن، فیلتر و سرویس‌های دوره‌ای", ["تعویض روغن", "فیلتر", "سرویس دوره‌ای"], ["oil_change"]],
  [9500018, "repair_shop", "TEST_ برق و دیاگ خلیج", "هرمزگان", "قشم", "مرکز شهر", "برق خودرو، باتری، دیاگ و عیب‌یابی الکترونیکی", ["برق خودرو", "دیاگ", "باتری"], ["auto_electrical"]],
] as const).map(([id, type, name, province, city, neighborhood, description, services, categoryKeys], index) => ({
  ...
  cover_url: `${ASSET_BASE}/${index % 3 === 0 ? "luxury-car.webp" : index % 3 === 1 ? "economic-car.webp" : "freezone-car.webp"}`,
